...
def get_parser(**parser_kwargs):
    ...
    parser.ad        return DataLoader(self.datasets["test"], batch_size=self.batch_size,
...
if __name__ == "__main__":
    ...
    if not opt.no_test and not trainer.interrupted:
        trainer.test(model, data)        return DataLoader(self.datasets["test"], batch_size=self.batch_size,
                          num_workers=self.num_workers, worker_init_fn=init_fn, shuffle=shuffle)
...
if __name__ == "__main__":
    ...
    if opt.train:
        try:
            ...
            raise
    if not opt.no_test and not trainer.interrupted:
        trainer.test(model, data)d_argument(
        "--pretrained_model",
        type=str,
        default="",
